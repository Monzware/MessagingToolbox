...
public class MessagingSystemNewWizard extends Wizard implements INewWizard {

	private List<ProviderConfiguration> providerConfigurations = new ArrayList<ProviderConfiguration>();

	private MessagingSystemNewWizardStartPage startPage = null;

	/**
	 * Constructor for SampleNewWizard.
	 */
	public MessagingSystemNewWizard() {
		super();
		...
		startPage = new MessagingSystemNewWizardStartPage(providerConfigurations);
	}
