...
public class MessagingSystemNewWizardStartPage extends WizardPage {

	private Text systemName;
	private Combo type;
	private final List<ProviderConfiguration> providerConfigurations;

	public MessagingSystemNewWizardStartPage(List<ProviderConfiguration> providerConfigurations) {
